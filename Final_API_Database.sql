...
CREATE TABLE `comment_tags` (
  ...
  CONSTRAINT `comment_tags_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`),
  CONSTRAINT `comment_tags_ibfk_2` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`id`)
...
-- Dump completed on 2021-08-12  7:49:06
